...
module.exports = {
    ...
    networks: {
        ...
        // ropsten: {
        //     provider: () => new HDWalletProvider(mnemonic, "https://ropsten.infura.io/v3/f2b8d8d4253d4da99fdeb8124dc0e106"),
        ...
        // },
        rinkeby: {
            provider: () => new HDWalletProvider(mnemonic, "wss://rinkeby.infura.io/ws/v3/f2b8d8d4253d4da99fdeb8124dc0e106"),
